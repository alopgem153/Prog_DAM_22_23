...
public class EjercicioStringBasicos5 {
    public static void main(String[] args) {
        ...
        int posicionEncontrada = cadena.indexOf(textoBuscado);

        System.out.println((posicionEncontrada >= 0) ? "Se encuentra en la posición: "+ posicionEncontrada
                                        : " No está ese texto");
